...
export const PRODUCTS: Product[] = [
  {
    ...
    sure: "9 sayfa",
    bolumler: [
      { baslik: "Doğum Anının Gökyüzü", aciklama: "Doğduğun anın gök haritası (natal çark) ve gezegen yerleşimlerinin tablosu." },
      { baslik: "Haritanın Ana İmzaları", aciklama: "12 evin anlamı (dolu evlerin vurgulu) ve seni en çok tanımlayan sekiz ana imza." },
      { baslik: "Nitelik Dengesi & İmza Sentezi", aciklama: "Element × nitelik diyagramın ve imzalarını tek portrede eriten sentez." },
      { baslik: "Element Dengesi & Mizacın", aciklama: "Dört elementin dağılımı, mizacın ve sana özel denge yorumu." },
      { baslik: "Sen Kimsin?", aciklama: "Güneş'in ve baskın temanın üzerinden çekirdek karakterinin portresi." },
      ...
      { baslik: "Enerji & Mizaç", aciklama: "Genel enerji tonun ve gündelik ritmin." },
  ...
  },
  {
    ...
    kartKisa: "Sevgi dilini, çekimini ve ilişki kalıplarını okuyan aşk odaklı harita analizi",
    aciklama:
    ...
    vurgu: "Aşk hayatını daha bilinçli kurmana ışık tutar.",
    accent: "#d98fae",
    accentVar: "acc-ask",
    glyph: "♀",
    ...
    sure: "7 sayfa",
    bolumler: [
      { baslik: "Doğum Anının Gökyüzü", aciklama: "Natal çarkın ve 12 evin anlamı; aşkla ilgili evlerin (5, 7, 8) vurgusuyla." },
      { baslik: "İmza Sentezi & Element Dengesi", aciklama: "Aşk imzalarının senteziyle element dağılımının duygusal ifadene etkisi." },
  ...
  },
  {
    ...
    kartKisa: "İş kimliğini, para ilişkini ve yaşam çağrını okuyan kariyer odaklı harita analizi",
    aciklama:
    ...
    vurgu: "Kariyer ve para yolunda yönünü netleştirir.",
    accent: "#4e9e7d",
    ...
    sure: "7 sayfa",
    bolumler: [
      { baslik: "Doğum Anının Gökyüzü", aciklama: "Natal çarkın ve 12 evin anlamı; kariyerle ilgili evlerin (2, 6, 10) vurgusuyla." },
      { baslik: "İmza Sentezi & Element Dengesi", aciklama: "Mesleki imzalarının senteziyle element dağılımının çalışma tarzına etkisi." },
  ...
  },
  {
    ...
    kartKisa: "Yaşam gücünü, mizacını ve iç dengeni okuyan enerji odaklı harita analizi",
    aciklama:
    ...
    vurgu: "Enerjini ve iç dengeni tanımana yardımcı olur.",
    accent: "#4ea64a",
    ...
    sure: "7 sayfa",
    bolumler: [
      { baslik: "Doğum Anının Gökyüzü", aciklama: "Natal çarkın ve 12 evin anlamı; enerjiyle ilgili evlerin (1, 6, 8) vurgusuyla." },
      { baslik: "İmza Sentezi & Element Dengesi", aciklama: "Enerji imzalarının senteziyle element dağılımının bedensel dengene etkisi." },
  ...
  },
  {
    ...
    sure: "7 sayfa",
    bolumler: [
      { baslik: "Doğum Anının Gökyüzü", aciklama: "Natal çarkın, ayın öne çıkan 3-4 gökyüzü başlığı ve bu ay aktive olan evlerin vurgusu." },
      { baslik: "İmza Sentezi & Element Dengesi", aciklama: "Ayın imzalarının senteziyle element dağılımının bu ayın enerjisiyle uyumu." },
    ...
    ornekler: ["/ornekler/aylik-1.png", "/ornekler/aylik-2.png", "/ornekler/aylik-3.png"],
    ornekIndir: [
      { dosya: "/ornekler/aylik-ornek.pdf", indirAd: "Gökname Aylık Burç Yorumu — Örnek Rapor.pdf" },
      { dosya: "/ornekler/aylik-ornek-2.pdf", indirAd: "Gökname Aylık Burç Yorumu — Örnek Rapor 2.pdf" },
      { dosya: "/ornekler/aylik-ornek-3.pdf", indirAd: "Gökname Aylık Burç Yorumu — Örnek Rapor 3.pdf" },
    ],
    ornekSayisi: 3,
  },
  {
    ...
    sure: "9 sayfa",
    bolumler: [
      { baslik: "Yılın Gökyüzü", aciklama: "Doğum haritan ve yıl haritan (Solar Return) yan yana." },
      { baslik: "Haritanın Ana İmzaları", aciklama: "12 evin anlamı, yılın odak evi vurgulu, ve yılın ana imzaları." },
      { baslik: "Nitelik Dengesi & İmza Sentezi", aciklama: "Yıl haritasının element × nitelik diyagramı ve imza sentezi." },
      { baslik: "Element Dengesi & Mizacın", aciklama: "Yıl haritasının element dağılımı ve yılın temposuna etkisi." },
  ...
  },
  {
    ...
    kartKisa: "Gölgeni, karmanı ve ruhsal yolculuğunu okuyan Lilith odaklı harita analizi",
    aciklama:
    ...
    vurgu: "Gölge yanlarınla yüzleşip dönüşmene rehberlik eder.",
    accent: "#bb3850",
    ...
    sure: "6 sayfa",
    bolumler: [
      { baslik: "Doğum Anının Gökyüzü", aciklama: "Natal çarkın yanında dört karmik noktan (Lilith, Ay Düğümleri, Kiron); karmik evlerin vurgusuyla." },
      { baslik: "İmza Sentezi & Element Dengesi", aciklama: "Karmik imzalarının senteziyle element dağılımının ruhsal tonuna etkisi." },
  ...
  },
  {
    ...
    bolumler: [
      ...
      { baslik: "Ev Bindirmeleri Yorumu & Gökyüzü Uyumu", aciklama: "Bindirmelerin ilişkinize kattıkları ve aranızdaki genel uyumun okuması." },
      { baslik: "Aranızdaki Denge", aciklama: "İki kişilik element ve nitelik tablosu: dengeniz, farklarınız ve yorumu." },
  ...
  },
  {
    ...
    bolumler: [
      { baslik: "Aranızdaki Gökyüzü", aciklama: "İki haritanız yan yana ve gezegenlerin birbirinizin evlerine düşüşü (bindirmeler)." },
      { baslik: "Ev Bindirmeleri Yorumu & Gökyüzü Uyumu", aciklama: "Bindirmelerin dostluğunuza kattıkları ve aranızdaki genel uyumun okuması." },
      { baslik: "Aranızdaki Denge", aciklama: "İki kişilik element ve nitelik tablosu: dengeniz, farklarınız ve yorumu." },
