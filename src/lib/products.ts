...
export const PRODUCTS: Product[] = [
  {
    ...
    bolumler: [
      ...
      { baslik: "Sağlık & Enerji", aciklama: "Genel enerji tonun, element dengen ve mizacın." },
  ...
  {
    slug: "saglik",
    ad: "Sağlık & Enerji Analizi",
    tamAd: "Sağlık ve enerji odaklı doğum haritası analizi",
    kisa: "Doğum haritanın sağlık ve enerji odaklı derin okuması",
    kartKisa: "Yaşam gücün, mizacın, denge rehberin",
    aciklama:
      "Mizacın ve element dengen merkezde olmak üzere yaşam gücünü, bedensel yapını, günlük sağlık ritmini, stres-denge tarzını ve sana yakışan yaşam temposunu okuyan analiz. (Tıbbi teşhis değil, enerji ve denge rehberi.)",
    accent: "#4ea64a",
    ...
    ornekIndir: [
      { dosya: "/ornekler/saglik-ornek-1.pdf", indirAd: "Gökname Sağlık & Enerji — Örnek Rapor 1.pdf" },
      { dosya: "/ornekler/saglik-ornek-2.pdf", indirAd: "Gökname Sağlık & Enerji — Örnek Rapor 2.pdf" },
      { dosya: "/ornekler/saglik-ornek-3.pdf", indirAd: "Gökname Sağlık & Enerji — Örnek Rapor 3.pdf" },
    ],
    fiyat: 99,
    eskiFiyat: 249,
    sure: "12-14 sayfa",
    bolumler: [
      { baslik: "Sağlık Haritan & Ana İmzalar", aciklama: "Haritanın enerji ve beden merceğinden okunuşu ve sağlıkla ilgili ana imzaların." },
      ...
      { baslik: "Günlük Sağlık & Rutinin", aciklama: "6. ev ve Merkür: beslenme, uyku ve hareket düzenine yatkınlığın." },
      ...
      { baslik: "Son Söz", aciklama: "Sağlık haritanı toparlayan, kişiye özel sıcak bir kapanış." },
    ],
    ornekSayisi: 2,
  },
  {
